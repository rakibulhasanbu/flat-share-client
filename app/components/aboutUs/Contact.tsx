                    ...
                    <div className="flex items-center lg:mb-0 mb-10">
                        <div className="">
                            ...
                            <form action="">
                                ...
                                <button className="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-primary shadow transition-all duration-700 hover:bg-primary">Submit</button>
                            </form>
                        </div>
                    </div>
                    <div className="lg:max-w-xl w-full h-[600px] flex items-center justify-center  bg-cover bg-no-repeat bg-[url('https://images.pexels.com/photos/821754/pexels-photo-821754.jpeg?auto=compress&cs=tinysrgb&w=600')] ">
                        <div className="lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
                            <h2 className="text-center pb-4 text-2xl font-semibold"> Flat Share</h2>
                            ...
                            <Link href="javascript:;" className="flex items-center mb-6">
                                ...
                                <h5 className="text-black text-base font-normal leading-6 ml-5">flatshare@gmail.com</h5>
                            </Link>
                            <Link href="javascript:;" className="flex items-center mb-6">
                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="flex items-center justify-center border-t border-gray-100 pt-6">
                                <Link href="javascript:;" className="mr-6">
